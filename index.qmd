...
library(tidyverse)
wkno <- c(1, 2)
date <- c("April 25, 2024", "May 16, 2024")
Topic <- c("[Introduction to R Programming](https://hellor.netlify.app/2021/week1/l12021#1)", "[Data Structures in R](https://hellor.netlify.app/slides/l22021#1)")
